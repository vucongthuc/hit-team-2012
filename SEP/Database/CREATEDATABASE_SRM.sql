...
CREATE TABLE VIEWLOG (VIEWLOGID BIGINT NOT NULL,
...
ALTER TABLE VIEWLOG
	ADD CONSTRAINT PK_VIEWLOG
		PRIMARY KEY (VIEWLOGID)

--REFERENCES KEY
ALTER TABLE VIEWLOG 
		ADD CONSTRAINT FK_VIEWLOG_STUDENT FOREIGN KEY (STUDENTID)
			REFERENCES STUDENT(STUDENTID)
			
ALTER TABLE VIEWLOG 
		ADD CONSTRAINT FK_VIEWLOG_USER FOREIGN KEY (USERID)
			REFERENCES [USER](USERID)